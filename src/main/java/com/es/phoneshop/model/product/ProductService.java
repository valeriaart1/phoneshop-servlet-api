...
public class ProductService {
    ...
    public List<Product> findProductsAdvancedSearch(String description, String minPrice, String maxPrice,
        ...
        if (maxPrice.isEmpty())
            maxPrice = sortByParameter(findProducts(null), "price", "desc").get(0).getPrice().toString();
        ...
        if (maxStock.isEmpty())
            maxStock = String.valueOf(sortByParameter(findProducts(null), "stock", "desc").get(0).getStock());
